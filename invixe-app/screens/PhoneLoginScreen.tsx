...
const styles = StyleSheet.create({
  ...
  character: { width: 120, height: 120, resizeMode: 'contain', marginBottom: 32 },
  input: {
    width: 260,
    height: 48,
  ...
  button: { backgroundColor: '#ff9800', borderRadius: 24, paddingVertical: 12, paddingHorizontal: 40, marginTop: 8 },
