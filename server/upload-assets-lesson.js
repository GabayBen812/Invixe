// Script to generate SQL for uploading lesson about asset types
const fs = require('fs');
const path = require('path');

// Lesson steps provided by user
const lessonData = [
  {
  ...
  {
    "id": "simple_question",
    "message": "מה זה אג''ח(אגרות חוב) ממשלתי לדעתך?",
    "backgroundImage": "bg1",
    ...
    "choices": [
      {
        "text": "הלוואה שנותנים למדינה תמורת ריבית קבועה",
  ...
  },
  {
    ...
    "choices": [
      {
        "text": "המשך",
        "nextStep": "1textWithImageExplain"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "choices": [
      {
        "text": "מטבעות עתיקים שמוצאים באתרים ארכיאולוגיים",
        "nextStep": "textWithImageExplain3",
        "correct": false
      },
      {
        "text": "דולר, אירו, שקל ושאר מטבעות – מסחר במטבעות זרים בבורסה",
        "nextStep": "textWithImageExplain3",
        "correct": true
      },
      {
        "text": "השקעות בחברות טכנולוגיה שנסחרות בארה\"ב",
        "nextStep": "textWithImageExplain3",
        "correct": false
      },
      {
        "text": "נכסים כמו זהב ונפט – סחורות",
        "nextStep": "textWithImageExplain3",
        "correct": false
      }
    ]
  ...
  },
  {
    ...
    "choices": [
      {
        "text": "מטבעות קריפטוגרפיים שאינם מונפקים ע\"י בנק",
        "nextStep": "textWithImageExplain5",
        "correct": true
      },
      {
        "text": "מטבעות שבעזרתם אפשר לקנות מניות",
        "nextStep": "textWithImageExplain5",
        "correct": false
      },
      {
        "text": "העברת כספים בעזרת אפליקציה ",
        "nextStep": "textWithImageExplain5",
        "correct": false
      },
      {
  ...
  },
  {
    ...
    "choices": [
      {
        "text": "המשך",
        "nextStep": "textWithImageExplain7"
      }
    ]
  },
  {
...
// Generate SQL
// This will create a new sublesson "סוגי נכסים" (Types of Assets) under lesson 3
const sql = `-- Upload new sublesson "סוגי נכסים" (Types of Assets) to lesson 3 "מושגים והיכרות כללית"
...
-- Insert or update sublesson "סוגי נכסים"
-- Using code 302 (for sublesson of lesson 3)
sublesson AS (
...
// Write to SQL file
const outputPath = path.join(__dirname, 'upload-assets-lesson.sql');
fs.writeFileSync(outputPath, sql, 'utf8');
console.log(`SQL file generated at: ${outputPath}`);
console.log(`\nLesson has ${lessonData.length} steps`);
console.log(`\nSublesson title: סוגי נכסים`);
console.log(`Sublesson code: 302`);
console.log(`\nTo upload, run the SQL in ${outputPath} in your Supabase SQL editor.`);
